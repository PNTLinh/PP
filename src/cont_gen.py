...
from src.dataloaders.vault  import load_vault
from src.dataloaders.mbpp  import load_mbpp
import logging
import argparse
import numpy as np
...
from src.models.models import build_or_load_gen_model
...
def main():
    ...
    parser.add_argument("--freeze_model", action="store_true", help="Freeze model parameters during training.")

    parser.add_argument('--test_file', type=str, default=None, help='Path to a custom evaluation file')
